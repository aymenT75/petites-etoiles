...
const i18n = {
  fr: {
    ...
    'music.desc':"Le premier single de Petites Étoiles raconte l'histoire d'Adam عليه السلام en 4 langues.",
  ...
  en: {
    ...
    'music.desc':"The first Petites Étoiles single tells the story of Adam عليه السلام in 4 languages.",
