...
const i18n = {
  ...
  en: {
    ...
    'prod1.name':'Digital Pack — Adam ✕ 4 languages','prod1.desc':'Download all 4 singles in high quality MP3 (320kbps).',
  ...
  ar: {
    ...
    'music.desc':'أولى أغاني نجوم صغيرة تحكي قصة آدم ﷺ بـ4 لغات.',
    ...
    'prod1.name':'باقة رقمية — آدم × 4 لغات','prod1.desc':'حمّل الأغاني الأربع بجودة عالية.',
